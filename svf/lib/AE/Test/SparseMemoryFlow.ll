; Full-sparse memory fixture. The first load drives a branch refinement of the
; backing ObjVar. The second load must observe both the SVFG reaching store and
; the branch constraint, so %memory_result has lower bound one.
