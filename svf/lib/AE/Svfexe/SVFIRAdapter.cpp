    ...
    const FunObjVar* function) const
{
    ...
    const auto iterator = functionEnvironments_.find(function);
    return iterator == functionEnvironments_.end() ? globalEnvironment_
                                                    : iterator->second;
}
